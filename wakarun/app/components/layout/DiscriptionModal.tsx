            ...
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 border-black bg-cover bg-[url('/images/modalbackground.png')] p-8 rounded-3xl z-20 w-[50vw] max-h-[80vh] overflow-auto scrollbar-none">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <p className="p-3 bg-white border-black border rounded-xl">{questionData.title}</p>
                    </div>
                    <div>
                        <h3 className="font-bold">問題文:</h3>
                        <p className="p-3 bg-white border-black border rounded-xl">{questionData.question}</p>
                    </div>
                    <div>
                        <h3 className="font-bold">解答:</h3>
                        <p className="p-3 bg-white border-black border rounded-xl">{questionData.answer}</p>
                    </div>
                    <p className="text-center font-bold">※上記の内容で作成してよろしいですか？</p>
                </div>
                <div className="relative -m-8 h-32"> {/* ボタン用のスペースを確保 */}
